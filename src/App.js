...
export default function App() {
	...
	return (
		<BrowserRouter>
			<Routes>
					<Route path='/profile/:platform/:summoner' element={<SummonerPage championData={championData} summonerSpellData={summonerSpellData} queueData={queueData} mapData={mapData} itemData={itemData}/>}/>
